...
public class SettingActivity extends AppCompatActivity {
    ...
    private LinearLayout llActiveEngine;
    private LinearLayout llFaceList;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        llActiveEngine = findViewById(R.id.ll_activeEngine);
        llFaceList = findViewById(R.id.ll_faceList);
        llRegister = findViewById(R.id.ll_register);
        title = findViewById(R.id.title);
        title.setTitle("设置");
        title.addLeftAction(new TitleBar.Action() {
            @Override
            public void onClick() {
                finish();
            }
        ...
        llActiveEngine.setOnClickListener(new View.OnClickListener() {
            @Override
    ...
    public void jumpToFaceList(View view) {
